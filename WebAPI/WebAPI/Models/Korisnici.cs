...
namespace WebAPI.Models
{
    public class Korisnici
    {
        ...
        public Korisnici(string putanja)
        {
            ...
            Voznja v = new Voznja() {Musterija="musterija", DatumIVrijemePorudzbe = DateTime.SpecifyKind(new DateTime(2010, 10, 10),DateTimeKind.Unspecified), Iznos = 5, Lokacija = new Lokacija() { Adresa = new Adresa() { Ulica = "kralja petra" } }, Komentar = new Komentar() { Opis = "kom1" }, TipAutomobila = TipoviAutomobila.PutnickiAutomobil, StatusVoznje = StatusiVoznje.Kreirana_NaCekanju, Vozac = "vozac", Odrediste = new Lokacija() { Adresa = new Adresa() { Ulica = "ulica" } } };
            Voznja v2 = new Voznja() { Musterija="musterija", DatumIVrijemePorudzbe = DateTime.SpecifyKind(new DateTime(2016, 11, 9), DateTimeKind.Unspecified), Iznos = 7, Lokacija = new Lokacija() { Adresa = new Adresa() { Ulica = "nikole tesle" } }, Komentar = new Komentar() { Opis = "kom2" }, TipAutomobila = TipoviAutomobila.PutnickiAutomobil, StatusVoznje = StatusiVoznje.Kreirana_NaCekanju, Vozac = "vozac", Odrediste = new Lokacija() { Adresa = new Adresa() { Ulica = "ulica" } } };
            Voznja v3 = new Voznja() { Musterija="", DatumIVrijemePorudzbe = DateTime.SpecifyKind(new DateTime(2013, 1, 8), DateTimeKind.Unspecified), Iznos = 8, Lokacija = new Lokacija() { Adresa = new Adresa() { Ulica = "veljka petrovica" } }, Komentar = new Komentar() { Opis = "kom3" }, TipAutomobila = TipoviAutomobila.KombiVozilo, StatusVoznje = StatusiVoznje.Prihvacena, Vozac = "vozac", Odrediste = new Lokacija() { Adresa = new Adresa() { Ulica = "ulica" } } };
            ListaVozaca.Add(new Vozac() { KorisnickoIme = "vozac", Lozinka = "vozac", Ime="MarkoV",Prezime="JankovicV", Uloga = Uloge.Vozac, Pol = Polovi.Muski, Voznje = new List<Voznja>() { v3 } });
            ListaVozaca.Add(new Vozac() { KorisnickoIme = "vozac1", Lozinka = "vozac1",Ime="Janko",Prezime="Markovic", Uloga = Uloge.Vozac, Pol = Polovi.Muski, Voznje = new List<Voznja>() { v3 } });
