...
namespace WebAPI.Models
{
    public class Korisnici
    {
        ...
        public Korisnici(string putanja)
        {
            ...
            Automobil a3 = new Automobil() { BrojTaksiVozila = 3, GodisteAutomobila = 1998, TipAutomobila = TipoviAutomobila.PutnickiAutomobil, Vozac="vozac3" };
            Automobil a4 = new Automobil() { BrojTaksiVozila = 3, GodisteAutomobila = 2010, TipAutomobila = TipoviAutomobila.PutnickiAutomobil, Vozac="vozac4" };
            Automobil a5 = new Automobil() { BrojTaksiVozila = 3, GodisteAutomobila = 2017, TipAutomobila = TipoviAutomobila.PutnickiAutomobil, Vozac="vozac5" };
            Automobil a6 = new Automobil() { BrojTaksiVozila = 3, GodisteAutomobila = 1989, TipAutomobila = TipoviAutomobila.KombiVozilo, Vozac="vozac6" };
            Automobil a7 = new Automobil() { BrojTaksiVozila = 3, GodisteAutomobila = 1991, TipAutomobila = TipoviAutomobila.KombiVozilo, Vozac="vozac7" };
