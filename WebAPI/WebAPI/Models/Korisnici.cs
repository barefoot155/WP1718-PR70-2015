...
namespace WebAPI.Models
{
    public class Korisnici
    {
        ...
        public Korisnici(string putanja)
        {
            ...
            Voznja v3 = new Voznja() { Musterija="", DatumIVrijemePorudzbe = new DateTime(2016, 10, 10), Iznos = 5, Lokacija = new Lokacija() { Adresa = new Adresa() { Ulica = "veljka petrovica" } }, Komentar = new Komentar() { Opis = "kom3" }, TipAutomobila = TipoviAutomobila.KombiVozilo, StatusVoznje = StatusiVoznje.Prihvacena, Vozac = "vozac", Odrediste = new Lokacija() { Adresa = new Adresa() { Ulica = "ulica" } } };
            ListaVozaca.Add(new Vozac() { KorisnickoIme = "vozac", Lozinka = "vozac", Uloga = Uloge.Vozac, Pol = Polovi.Muski, Voznje = new List<Voznja>() { v3 } });
            ListaVozaca.Add(new Vozac() { KorisnickoIme = "vozac1", Lozinka = "vozac1", Uloga = Uloge.Vozac, Pol = Polovi.Muski, Voznje = new List<Voznja>() { v3 } });
